...
public class Play extends State {
	...
	public StatesMachine run() {
		PlayStatus status = PlayStatus.valueOf(workflowService.getStatus(ConfigurationSingleton.INSTANCE.getIdPartie(), ConfigurationSingleton.INSTANCE.getIdEquipe()));
		switch (status) {
		case FORBIDDEN:
		case GAMEOVER:
